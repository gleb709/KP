...
<div class="header">
    ...
    <div class="nav">
        ...
        <div id="detail" class="details">
            ...
            <form class="nav_form" action="controller" method="post">
                <div class="nav_box">
                    <img width="40" height="40" src="${pageContext.request.contextPath}/image/addAdmin.jpg"/>
                    <input class="inputButton" type="submit" value="<fmt:message key="button.addAdmin"/>"/>
                    <input type="hidden" name="command" value="TRANSFER"/>
