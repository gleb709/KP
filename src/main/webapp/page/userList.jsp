                ...
                <div class="actionBox">
                    <div>
                        <form class="actionForm" action="controller" method="post">
                            <input class="listButton" type="submit" name="blocked_users" value="<fmt:message key="button.blockedUserList"/>"/>
                            <input type="hidden" name="command" value="TRANSFER"/>
                            <input type="hidden" name="page" value="BLOCKED_USER_LIST"/>
                        </form>
                        <form class="actionForm" action="controller" method="post">
                            ...
                            <form class="actionForm" action="controller" method="post">
                                ...
                                <c:choose>
                                    <c:when test="${incorrectData.equals('invalid')}">
                                        <input class="listText" type="text" name="contractNumber" placeholder="<fmt:message key="label.incorrectContractNumber"/>"/>
                                    </c:when>
                                    <c:otherwise>
                                        <input class="listText" type="text" name="contractNumber" placeholder="<fmt:message key="label.contractNumber"/>"/>
                                    </c:otherwise>
                                </c:choose>
                                <input type="hidden" name="command" value="USER_ACCOUNT_INFO"/>
                            </form>
                        </div>
                    </div>
                </div>
